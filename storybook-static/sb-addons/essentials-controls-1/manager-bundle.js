try {
  ...
  var S = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    p2 = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of l2(t))
          !d2.call(e, a) && a !== r && Aa(e, a, { get: () => t[a], enumerable: !(n = s2(t, a)) || n.enumerable });
      return e;
    };
  var fe = (e, t, r) => (
    (r = e != null ? u2(c2(e)) : {}),
  ...
  var Zs = S((gq, Qs) => {
    ...
    var Js = Xs(),
      ...
      BE = on();
    function TE() {
      (this.size = 0), (this.__data__ = { hash: new Js(), map: new (BE || wE)(), string: new Js() });
    }
    Qs.exports = TE;
  });
  var tl = S((Aq, el) => {
  ...
  var mn = S((k$, ec) => {
    ...
    function mv(e, t) {
      var r = typeof e;
      return (t = t ?? fv), !!t && (r == "number" || (r != "symbol" && hv.test(e))) && e > -1 && e % 1 == 0 && e < t;
    }
    ec.exports = mv;
  });
  var gn = S((q$, tc) => {
  ...
  var Uc = S((iU, Hc) => {
    ...
    function nC(e, t, r, n, a, o) {
      ...
      if (m && !y) return o || (o = new Bo()), i || eC(e) ? JD(e, t, r, n, a, o) : QD(e, t, s, r, n, a, o);
      if (!(r & tC)) {
  ...
  var To = S((cU, Wc) => {
    ...
    function Gc(e, t, r, n, a) {
      return e === t ? !0 : e == null || t == null || (!zc(e) && !zc(t)) ? e !== e && t !== t : aC(e, t, r, n, Gc, a);
    }
    Wc.exports = Gc;
  });
  var Kc = S((hU, Vc) => {
  ...
  var Fd = S((Bz, Sd) => {
    ...
    function lx(e, t, r) {
      ...
      return o || ++n != a ? o : ((a = e == null ? 0 : e.length), !!a && ux(a) && ix(i, a) && (ox(e) || ax(e)));
    }
    Sd.exports = lx;
  });
  var Po = S((Rz, wd) => {
  ...
  var Cn = S((cG, jd) => {
    ...
    var qd = No();
    function jx(e, t, r) {
      t == "__proto__" && qd ? qd(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r);
    }
    jd.exports = jx;
  });
  var xn = S((hG, $d) => {
  ...
  var yf = S((kV, gf) => {
    ...
    function kw(e) {
      ...
      return t && typeof e[0] == "string" && Iw.call(e, "index") && ((r.index = e.index), (r.input = e.input)), r;
    }
    gf.exports = kw;
  });
  var _n = S((qV, Ef) => {
  ...
  var L0 = S((hX, N0) => {
    ...
    var IB = I0(),
      ...
      NB = k0
        ? function (e, t) {
            return k0(e, "toString", { configurable: !0, enumerable: !1, value: IB(t), writable: !0 });
          }
        : kB;
    N0.exports = NB;
  });
  ...
  var yh = S((HJ, gh) => {
    ...
    gh.exports = function (t) {
      ...
      for (
        ...
        u[s] = "$" + s;
      if (
        ((a = Function("binder", "return function (" + RT(u, ",") + "){ return binder.apply(this,arguments); }")(o)),
        r.prototype)
      ) {
        var p = function () {};
  ...
  var pt = S((eQ, Sh) => {
    ...
    var si = function () {
      ...
      wt = {
        ...
        "%MapIteratorPrototype%": typeof Map > "u" || !Yt || !De ? ee : De(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%": typeof Set > "u" || !Yt || !De ? ee : De(new Set()[Symbol.iterator]()),
    ...
    Sh.exports = function (t, r) {
      ...
      if (arguments.length > 1 && typeof r != "boolean") throw new Jt('"allowMissing" argument must be a boolean');
      if (UT(/^%?[^%]*%?$/, t) === null)
      ...
      for (var y = 1, E = !0; y < n.length; y += 1) {
        ...
        if (((m === "constructor" || !E) && (s = !0), (a += "." + m), (i = "%" + a + "%"), Gn(wt, i))) u = wt[i];
        else if (u != null) {
          if (!(m in u)) {
  ...
  var pm = S((PQ, dm) => {
    ...
    var xi = typeof Map == "function" && Map.prototype,
      mi = Object.getOwnPropertyDescriptor && xi ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
      Xn = xi && mi && typeof mi.get == "function" ? mi.get : null,
      Vh = xi && Map.prototype.forEach,
      Si = typeof Set == "function" && Set.prototype,
      gi = Object.getOwnPropertyDescriptor && Si ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
      ...
      Ai = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? Symbol.prototype.toString : null,
      ...
      Zh =
        ...
        ([].__proto__ === Array.prototype
          ...
          : null);
    function em(e, t) {
      if (e === 1 / 0 || e === -1 / 0 || e !== e || (e && e > -1e3 && e < 1e3) || om.call(/e/, t)) return t;
    ...
    dm.exports = function e(t, r, n, a) {
      ...
      if ((typeof n > "u" && (n = 0), n >= y && y > 0 && typeof t == "object")) return Di(t) ? "[Array]" : "[Object]";
      var E = _8(o, n);
      if (typeof a > "u") a = [];
      ...
      if (typeof t == "function" && !nm(t)) {
        var g = v8(t),
          A = Yn(t, m);
        return (
          "[Function" + (g ? ": " + g : " (anonymous)") + "]" + (A.length > 0 ? " { " + Ye.call(A, ", ") + " }" : "")
        );
      }
      if (sm(t)) {
      ...
      if (w8(t)) {
        for (var x = "<" + Xh.call(String(t.nodeName)), F = t.attributes || [], B = 0; B < F.length; B++)
      ...
      if (!h8(t) && !nm(t)) {
        ...
        return k.length === 0 ? X + "{}" : E ? X + "{" + Ci(k, E) + "}" : X + "{ " + Ye.call(k, ", ") + " }";
      }
      return String(t);
    };
    function um(e, t, r) {
      ...
      for (var s in e)
        ft(e, s) &&
          ((r && String(Number(s)) === s && s < e.length) ||
            ...
            (om.call(/[^\w$]/, s) ? n.push(t(s, e) + ": " + t(e[s], e)) : n.push(s + ": " + t(e[s], e))));
      if (typeof yi == "function")
        for (var p = 0; p < o.length; p++) im.call(e, o[p]) && n.push("[" + t(o[p]) + "]: " + t(e[o[p]], e));
      return n;
    }
  });
  var hm = S((LQ, fm) => {
      ...
      Y8 = function (t, r, n, a, o) {
        ...
        for (var u = "", s = 0; s < i.length; ++s) {
          ...
          (s += 1),
            ...
            (u += Xe[240 | (p >> 18)] + Xe[128 | ((p >> 12) & 63)] + Xe[128 | ((p >> 6) & 63)] + Xe[128 | (p & 63)]);
        }
        return u;
      },
      X8 = function (t) {
  ...
  var Cm = S((YQ, Dm) => {
    ...
    var Am = hm(),
      ...
      o_ = function e(t, r, n, a, o, i, u, s, p, y, E, m, g, A, b, x) {
        ...
        var U;
        if (n === "comma" && at(F))
          A && u && (F = ta.maybeMap(F, u)), (U = [{ value: F.length > 0 ? F.join(",") || null : void 0 }]);
        else if (at(s)) U = s;
        else {
          var V = Object.keys(F);
          U = p ? V.sort(p) : V;
        ...
        for (var H = a && at(F) && F.length === 1 ? r + "[]" : r, oe = 0; oe < U.length; ++oe) {
          ...
          if (!(i && Y === null)) {
            var R = at(F) ? (typeof n == "function" ? n(H, X) : H) : H + (y ? "." + X : "[" + X + "]");
            x.set(t, I);
            var _ = Am();
            _.set(Ri, x), vm(k, e(Y, R, n, a, o, i, n === "comma" && A && at(F) ? null : u, s, p, y, E, m, g, A, b, _));
          }
        }
        return k;
      },
      i_ = function (t) {
        ...
        if (typeof t.format < "u") {
          if (!t_.call(zr.formatters, t.format)) throw new TypeError("Unknown format option provided.");
          n = t.format;
        }
    ...
    Dm.exports = function (e, t) {
      var r = e,
        ...
        a,
        o;
      typeof n.filter == "function" ? ((o = n.filter), (r = o("", r))) : at(n.filter) && ((o = n.filter), (a = o));
      var i = [];
      ...
      return (
        n.charsetSentinel && (n.charset === "iso-8859-1" ? (A += "utf8=%26%2310003%3B&") : (A += "utf8=%E2%9C%93&")),
        g.length > 0 ? A + g : ""
      );
    };
  });
      ...
      d_ = function (t, r) {
        ...
        if (r.charsetSentinel)
          for (s = 0; s < i.length; ++s)
            i[s].indexOf("utf8=") === 0 &&
              (i[s] === c_ ? (p = "utf-8") : i[s] === l_ && (p = "iso-8859-1"), (u = s), (s = i.length));
        for (s = 0; s < i.length; ++s)
          if (s !== u) {
            var y = i[s],
              E = y.indexOf("]="),
      ...
      f_ = function (t, r, n, a) {
        if (t) {
          ...
          for (var E = 0; n.depth > 0 && (s = u.exec(o)) !== null && E < n.depth; ) {
            if (((E += 1), !n.plainObjects && Pi.call(Object.prototype, s[1].slice(1, -1)) && !n.allowPrototypes))
              return;
            y.push(s[1]);
          }
...
`;
      ...
      function R() {
        ...
        return (
          (T = X()),
          i === t.DOT_LT || i === t.LT
            ? (M(), (P = Y()), N(t.GT), A({ type: e.TypeApplication, expression: T, applications: P }, [L, o]))
            : T
        );
      }
      function _() {
        ...
        return (
          ...
          i !== t.RPAREN &&
            (i === t.NAME && (u === "this" || u === "new")
              ? ((T = u === "new"), w(t.NAME), N(t.COLON), (P = R()), i === t.COMMA && (w(t.COMMA), (L = j())))
              : (L = j())),
          N(t.RPAREN),
          (O = null),
          i === t.COLON && (O = _()),
      ...
      function K() {
        ...
        return i === t.QUESTION
          ...
          : i === t.BANG
            ? ((P = a - 1), w(t.BANG), A({ type: e.NonNullableType, expression: J(), prefix: !0 }, [P, o]))
            : ((P = o),
              (T = J()),
              i === t.BANG
...
\u2028\u2029])`;
      ...
      function M(w, N) {
        for (var k = w.replace(/^\/\*\*?/, ""), U = 0, V = new RegExp(B, "g"), H; (H = V.exec(k)); )
          if (((U += H[1].length), H.index + H[0].length > N + U)) return N + U + w.length - k.length;
      ...
      (function (w) {
        ...
        function G() {
          var L,
            ...
            $ = k;
          for (O = !1; $ < V; ) {
            if (((L = H.charCodeAt($)), n.code.isLineTerminator(L) && !(L === 13 && H.charCodeAt($ + 1) === 10)))
              O = !0;
            else if (O) {
              if (L === 64) break;
        ...
        function Z(L) {
          for (; k < L && (n.code.isWhiteSpace(H.charCodeAt(k)) || n.code.isLineTerminator(H.charCodeAt(k))); ) _();
        }
        function se(L, O, $) {
          var z = "",
            pe,
        ...
        (Q.prototype.addError = function (O) {
          ...
          return this._tag.errors || (this._tag.errors = []), R && t.throwError(z), this._tag.errors.push(z), X;
        }),
          ...
          (Q.prototype.parseName = function () {
            var L, O;
            if (m(this._title))
              if (((this._tag.name = se(this._last, Y && A(this._title), g(this._title))), this._tag.name))
                (O = this._tag.name),
                  O.charAt(0) === "[" &&
                    O.charAt(O.length - 1) === "]" &&
          ...
          (Q.prototype.parse = function () {
            ...
            for (
              this._last = G(this._title),
                this._options.range &&
                  (this._tag.range = [this._first, H.slice(0, this._last).replace(/\s*$/, "").length].map(Ne)),
                a(N, this._title)
                  ? (z = N[this._title])
        ...
        function P(L, O) {
          ...
          for (
            V = H.length, k = 0, U = 0, X = O.recoverable, Y = O.sloppy, R = O.strict, pe = T(O.preserveWhitespace);
            (z = He(O)), !!z;
    ...
    pg.exports = function (e) {
      ...
      function p(B) {
        ...
        return (
          ...
          M.setAttribute("class", e.linkClass + i + "node-name--" + B.nodeName + i + e.extraLinkClasses),
          I.appendChild(M),
          I
        );
      }
      function y(B) {
        ...
        return B && ((w = w + i + e.collapsibleClass), (w = w + i + e.isCollapsedClass)), M.setAttribute("class", w), M;
      }
      function E() {
        ...
        e.fixedSidebarOffset === "auto" && (e.fixedSidebarOffset = a.offsetTop),
          B > e.fixedSidebarOffset
            ? I.className.indexOf(e.positionFixedClass) === -1 && (I.className += i + e.positionFixedClass)
            : (I.className = I.className.replace(i + e.positionFixedClass, ""));
      }
      function m(B) {
        var I = 0;
        return B !== null && ((I = B.offsetTop), e.hasInnerContainers && (I += m(B.offsetParent))), I;
      }
      function g(B, I) {
      ...
      function A(B) {
        ...
        if (o && a !== null && M.length > 0) {
          ...
          H && H.className.indexOf(e.activeListItemClass) === -1 && (H.className += i + e.activeListItemClass);
          var oe = a.querySelectorAll("." + e.listClass + "." + e.collapsibleClass);
          t.call(oe, function (X) {
            X.className.indexOf(e.isCollapsedClass) === -1 && (X.className += i + e.isCollapsedClass);
          }),
            k &&
              k.nextSibling &&
            ...
            if (F !== null) {
              ...
              if (B !== null && ((y = s.selectHeadings(F, r.headingSelector)), y !== null)) {
                ...
                (this._scrollListener = g(function (N) {
                  ...
                  var k = N && N.target && N.target.scrollingElement && N.target.scrollingElement.scrollTop === 0;
                ...
                return [
                  ...
                  function (x) {
                    ...
                    F < 37 ||
                      F > 40 ||
                      (x.preventDefault(),
                      i({ left: F === 39 ? 0.05 : F === 37 ? -0.05 : 0, top: F === 40 ? 0.05 : F === 38 ? -0.05 : 0 }));
                  },
                  b,
                ];
              },
      ...
      (H4 = typeof window < "u" ? Fu : he),
        ...
        (z4 = function (e) {
          ...
          return h.createElement(
            ...
            h.createElement(Tg, { hue: p.h, onChange: y, className: "react-colorful__last-control" }),
          );
        }),
        (G4 = {
          defaultColor: "000",
        ...
        (W4 = function (e) {
          ...
          return h.createElement(
            ...
            h.createElement(
              ...
              h.createElement(Xi, { className: "react-colorful__alpha-pointer", left: r.a, color: la(r) }),
            ),
          );
        }),
        (Ng = function (e) {
  ...
  var Gg = S((Ere, zg) => {
    ...
    function Z4(e, t) {
      let r = [t[e].parent, e],
        n = ca[t[e].parent][e],
        a = t[e].parent;
      for (; t[a].parent; ) r.unshift(t[a].parent), (n = Q4(ca[t[a].parent][a], n)), (a = t[a].parent);
    ...
    my = Ze(() => {
      ...
      (wR = q.div({ position: "relative", maxWidth: 250 })),
        ...
        (ly = ({ value: e, active: t, onClick: r, style: n, ...a }) => {
          ...
          return h.createElement(RR, { ...a, active: t, onClick: r, style: { ...n, backgroundImage: o } });
        }),
        ...
        (UR = (e, t, r) => {
          ...
          let o = ot(
              () =>
                (e || [])
                  .map((u) =>
                    typeof u == "string" ? cr(u) : u.title ? { ...cr(u.color), keyword: u.title } : cr(u.color),
                  )
                  .concat(n)
                  .filter(Boolean)
                  .slice(-27),
        ...
        (fy = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a, presetColors: o, startOpen: i = !1 }) => {
          let u = ge((0, dy.default)(r, 200), [r]),
            { value: s, realValue: p, updateValue: y, color: E, colorSpace: m, cycleColorSpace: g } = HR(t, u),
  ...
  var o1 = /^#[a-fA-F0-9]{6}$/,
    ...
    l1 = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i,
    c1 = /^hsl\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*\)$/i,
    d1 =
  ...
  function ro(e, t, r) {
    if (typeof e == "number" && typeof t == "number" && typeof r == "number") return to("#" + At(e) + At(t) + At(r));
    if (typeof e == "object" && t === void 0 && r === void 0) return to("#" + At(e.red) + At(e.green) + At(e.blue));
    throw new Ie(6);
  }
  function Ue(e, t, r, n) {
  ...
  var TS = Object.create,
    ...
    kS = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of OS(t))
          !PS.call(e, a) && a !== r && rp(e, a, { get: () => t[a], enumerable: !(n = _S(t, a)) || n.enumerable });
      return e;
    },
    NS = (e, t, r) => (
      (r = e != null ? TS(RS(e)) : {}),
  ...
  var tp = NS(LS()),
    ...
    $o = (e, t, r) => {
      ...
      if (np([n, a]) !== 1) throw new Error(`Invalid conditional value ${JSON.stringify({ arg: n, global: a })}`);
      let o = n ? t[n] : r[a];
      return MS(e.if, o);
    };
  l();
...
`,
      ...
      if (b.length > 1 || t.forceWrapper) F = b;
        ...
        if (b.length === 1) return (F = b[0]), typeof F == "string" ? n("span", { key: "outer" }, F) : F;
        F = null;
      }
                ...
                N = (b[w] = (function (k, U) {
                  return k === "style"
                    ? U.split(/;\s?/).reduce(function (V, H) {
                        ...
                        return (
                          (V[oe.replace(/(-[a-z])/g, (X) => X[1].toUpperCase())] = H.slice(oe.length + 1).trim()), V
                        );
                      }, {})
                    : k === "href"
                      ? Wt(U)
                      : (U.match(rF) && (U = U.slice(1, U.length - 1)), U === "true" || (U !== "false" && U));
                })(I, M));
              typeof N == "string" && (Wo.test(N) || Vo.test(N)) && (b[w] = me(a(N.trim()), { key: F }));
    ...
    let i = [],
      ...
      s = {
        ...
        codeBlock: {
          ...
          h: (g, A, b) => n("pre", { key: b.k }, n("code", xt({}, g.O, { className: g.M ? `lang-${g.M}` : "" }), g.v)),
        },
        codeFenced: {
          t: nt(pp),
          i: te.MAX,
        ...
        codeInline: { t: dt(VS), i: te.LOW, l: (g) => ({ v: g[2] }), h: (g, A, b) => n("code", { key: b.k }, g.v) },
...
`,
        ...
        text: {
          t: Or(xF),
          i: te.MIN,
          l: (g) => ({ v: g[0].replace(eF, (A, b) => (t.namedCodesToUnicode[b] ? t.namedCodesToUnicode[b] : A)) }),
          h: (g) => g.v,
        },
        textBolded: {
          t: dt(EF),
        ...
        textMarked: { t: dt(vF), i: te.LOW, l: Ho, h: (g, A, b) => n("mark", { key: b.k }, A(g.v, b)) },
        textStrikethroughed: { t: dt(DF), i: te.LOW, l: Ho, h: (g, A, b) => n("del", { key: b.k }, A(g.v, b)) },
      };
...
`,
  ...
  var nB = Object.create,
    ...
    uB = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of u0(t))
          !iB.call(e, a) && a !== r && i0(e, a, { get: () => t[a], enumerable: !(n = aB(t, a)) || n.enumerable });
      return e;
    },
    s0 = (e, t, r) => (
      (r = e != null ? nB(oB(e)) : {}),
    ...
    var a = n.reduce(function (u, s) {
      ...
      return p
        ? u.concat(
            p.map(function (y) {
              var E, m;
              return (m = (E = y.match(/[\t ]/g)) === null || E === void 0 ? void 0 : E.length) !== null && m !== void 0
                ? m
                : 0;
            }),
          )
...
`,
  ...
  var ai = (e, t, r) => {
      ...
      `),
          ...
          : (r.add(e),
            Array.isArray(e)
              ? { name: "array", value: e.length > 0 ? ai(e[0], t, new Set(r)) : { name: "other", value: "unknown" } }
  ...
  function ii(e) {
    ...
    return {
      ...
      decorators: jn(e, "decorators", { reverseFileOrder: !(ue.FEATURES?.legacyDecoratorFileOrder ?? !1) }),
      args: $n(e, "args"),
      ...
      "../../node_modules/entities/lib/encode.js"(e) {
        ...
        function p(B) {
          ...
          for (var U = 0; U < I.length - 1; U++) {
            for (var V = U; V < I.length - 1 && I[V].charCodeAt(1) + 1 === I[V + 1].charCodeAt(1); ) V += 1;
            var H = 1 + V - U;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        function i(R, _) {
          if (R) {
            ...
            if ((j === "Object" && R.constructor && (j = R.constructor.name), j === "Map" || j === "Set"))
              return Array.from(j);
            if (j === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(j)) return u(R, _);
          }
        }
        function u(R, _) {
        ...
        function N(R, _, j) {
          return j || (j = ""), R.push(_), "<".concat(_).concat(j ? ' style="'.concat(j, '"') : "", ">");
        }
        function k(R, _) {
          return N(R, "span", _);
        }
        ...
        function X(R, _, j) {
          return _ !== "text" && ((R = R.filter(I(M(j)))), R.push({ token: _, data: j, category: M(j) })), R;
        }
        var Y = (function () {
          function R(_) {
            r(this, R),
  ...
  var H_ = Object.create,
    ...
    W_ = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of zm(t))
          !G_.call(e, a) && a !== r && Um(e, a, { get: () => t[a], enumerable: !(n = U_(t, a)) || n.enumerable });
      return e;
    },
    aa = (e, t, r) => (
      (r = e != null ? H_(z_(e)) : {}),
      ...
      "node_modules/get-intrinsic/index.js"(e, t) {
        ...
        t.exports = function (Y, R) {
          ...
          for (var ke = 1, Ne = !0; ke < _.length; ke += 1) {
            ...
            if (((Q === "constructor" || !Ne) && (Z = !0), (j += "." + Q), (J = "%" + j + "%"), B(A, J))) K = A[J];
            else if (K != null) {
              if (!(Q in K)) {
              ...
              if (u && ke + 1 >= _.length) {
                var P = u(K, Q);
                (Ne = !!P), Ne && "get" in P && !("originalValue" in P.get) ? (K = P.get) : (K = K[Q]);
              } else (Ne = B(K, Q)), (K = K[Q]);
              Ne && !Z && (A[J] = K);
            }
          }
...
` &&
  ...
  var be = (e) => `& :where(${e}:not(.sb-anchor, .sb-unstyled, .sb-unstyled ${e}))`,
    ...
    Ane = q.h1(Pt, ({ theme: e }) => ({
      ...
      lineHeight: "32px",
      [`@media (min-width: ${pu}px)`]: { fontSize: e.typography.size.l1, lineHeight: "36px", marginBottom: "16px" },
    })),
    vne = q.h2(Pt, ({ theme: e }) => ({
      ...
      borderBottom: "none",
      marginBottom: 15,
      [`@media (min-width: ${pu}px)`]: { fontSize: e.typography.size.m1, lineHeight: "28px", marginBottom: 24 },
  ...
  var ba = (e) => ({
    ...
    XR = q(Oa)({ position: "absolute", left: 0, right: 0, top: 0, transition: "transform .2s linear" }),
    JR = ({ isLoading: e, storyId: t, baseUrl: r, zoom: n, resetZoom: a, ...o }) =>
      h.createElement(
        ...
        h.createElement(
          Cu,
          { key: "left" },
          e ? [1, 2, 3].map((i) => h.createElement(Ia, { key: i })) : h.createElement(YR, { zoom: n, resetZoom: a }),
        ),
      ),
    Ly = fr({ scale: 1 }),
    { window: QR } = ue,
  ...
  var l9 = q(JR)({ position: "absolute", top: 0, left: 0, right: 0, height: 40 }),
    ...
    by = (e, t = !0) => {
      let r = e;
      return t || (r = e.slice(0, iu)), r.map((n) => h.createElement(My, { key: n, text: n === "" ? '""' : n }));
    },
    C9 = ({ value: e, initialExpandedArgs: t }) => {
      ...
      if (n == null) {
        ...
        return y > iu
          ? h.createElement(
              ...
              { isExpanded: i },
              by(p, i),
              h.createElement(g9, { onClick: () => u(!i) }, i ? "Show less..." : `Show ${y - iu} more...`),
            )
      ...
      return h.createElement(
        ja,
        {
          ...
          tooltip: h.createElement(b9, { width: v9(n) }, h.createElement(tn, { language: "jsx", format: !1 }, n)),
        },
        h.createElement(
          y9,
    ...
    tu = ({ value: e, initialExpandedArgs: t }) =>
      e == null ? h.createElement(A9, null) : h.createElement(C9, { value: e, initialExpandedArgs: t }),
    x9 = q.label(({ theme: e }) => ({
      lineHeight: "18px",
      alignItems: "center",
      marginBottom: 8,
      ...
      span: {
        ...
        "&:active": { boxShadow: `${Er(0.05, e.appBorderColor)} 0 0 0 2px inset`, color: Er(1, e.appBorderColor) },
        "&:first-of-type": { paddingRight: 8 },
        "&:last-of-type": { paddingLeft: 8 },
      },
      "input:checked ~ span:last-of-type, input:not(:checked) ~ span:first-of-type": {
        background: e.boolean.selectedBackground,
        boxShadow: e.base === "light" ? `${Er(0.1, e.appBorderColor)} 0 0 2px` : `${e.appBorderColor} 0 0 0 1px`,
        color: e.color.defaultText,
        padding: "7px 15px",
      },
    })),
    ...
    R9 = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a }) => {
      let [o, i] = re(!0),
        ...
        s = Se();
      he(() => {
        o !== !1 && (u && u.current && (u.current.value = T9(t)), s && s.current && (s.current.value = _9(t)));
      }, [t]);
      let p = (m) => {
  ...
  var k9 = ({ name: e, value: t, onChange: r, min: n, max: a, step: o, onBlur: i, onFocus: u }) => {
    ...
    G9 = (e, t) => (Array.isArray(e) ? e.reduce((r, n) => ((r[t?.[n] || String(n)] = n), r), {}) : e),
    W9 = { check: Ey, "inline-check": Ey, radio: Ay, "inline-radio": Ay, select: Dy, "multi-select": Dy },
    dr = (e) => {
      let { type: t = "select", labels: r, argType: n } = e,
        a = { ...e, options: n ? G9(n.options, r) : {}, isInline: t.includes("inline"), isMulti: t.includes("multi") },
        o = W9[t];
    ...
    handleAddValueAdd({ newValue: e }) {
      ...
      a(t.length, r, n, e)
        .then(() => {
          ...
          u(r[r.length - 1], i), s({ type: Uy, keyPath: r, deep: n, key: i.length - 1, newValue: e });
        })
        .catch(o.error);
    }
      ...
      return new Promise((r, n) => {
        ...
        a(e, i, u, s, t)
          .then(() => {
            ...
            p(i[i.length - 1], o), y({ type: Gy, keyPath: i, deep: u, key: e, newValue: t, oldValue: s }), r(void 0);
          })
          .catch(n);
      });
    }
  ...
  var Ky = class extends et {
    ...
    render() {
      ...
      if (r && !B) {
        ...
        (x = h.createElement("span", { className: "rejt-edit-form", style: b.editForm }, N, " ", w, M)), (F = null);
      } else {
        x = h.createElement(
          "span",
      ...
      return new Promise((r, n) => {
        ...
        a(e, i, u, s, t)
          .then(() => {
            (o[e] = t), this.setState({ data: o });
            let { onUpdate: p, onDeltaUpdate: y } = this.props;
            p(i[i.length - 1], o), y({ type: Gy, keyPath: i, deep: u, key: e, newValue: t, oldValue: s }), r();
          })
          .catch(n);
      });
    }
  ...
  var gt = class extends et {
    ...
    render() {
      ...
      return h.createElement(
        ...
        h.createElement("span", { className: "rejt-name", style: b.name }, e, " : "),
        F
          ? h.createElement("span", { className: "rejt-edit-form", style: b.editForm }, w, " ", M, I)
          : h.createElement(
              "span",
  ...
  var vP = ({ name: e, value: t, onChange: r, min: n = 0, max: a = 100, step: o = 1, onBlur: i, onFocus: u }) => {
      let s = (E) => {
          r(I9(E.target.value));
        },
        p = t !== void 0,
      ...
      return h.createElement(
        ...
        h.createElement(bP, { numberOFDecimalsPlaces: y, max: a }, p ? t.toFixed(y) : "--", " / ", a),
      );
    },
    DP = q.label({ display: "flex" }),
    CP = q.div(({ isMaxed: e }) => ({ marginLeft: "0.75rem", paddingTop: "0.35rem", color: e ? "red" : void 0 })),
  ...
  var wP = ({ onChange: e, name: t, accept: r = "image/*", value: n }) => {
    ...
    TP = (e) => h.createElement(xu, { fallback: h.createElement("div", null) }, h.createElement(BP, { ...e })),
    _P = {
      array: Sy,
      object: Sy,
      boolean: F9,
    ...
    PP = q.span(({ theme: e }) => ({ color: e.color.negative, fontFamily: e.typography.fonts.mono, cursor: "help" })),
    IP = q.div(({ theme: e }) => ({
    ...
    LP = q.td(({ theme: e, expandable: t }) => ({ paddingLeft: t ? "40px !important" : "20px !important" })),
    ma = (e) => {
      let [t, r] = re(!1),
        ...
        o
          ...
          : h.createElement(
              ...
              y.jsDocTags != null
                ...
                : h.createElement(kP, { hasDescription: A }, h.createElement(tu, { value: E, initialExpandedArgs: u })),
            ),
        o ? null : h.createElement("td", null, h.createElement(tu, { value: m, initialExpandedArgs: u })),
      ...
      return h.createElement(
        ...
        h.createElement(
          ...
          h.createElement(
            HP,
            { colSpan: a - 1 },
            h.createElement(wy, { onClick: (m) => i(!o), tabIndex: -1, style: { outline: "none" } }, E),
            o ? null : p,
          ),
        ),
        o ? r : null,
    ...
    YP = q.div(({ theme: e }) => ({ display: "flex", fontSize: e.typography.size.s2 - 1, gap: 25 })),
      ...
      return h.createElement(
        ...
        h.createElement(
          ...
          h.createElement(
            ...
            E.ungrouped.map((B) => h.createElement(ma, { key: B.key, row: B, arg: p && p[B.key], ...F })),
            Object.entries(E.ungroupedSubsections).map(([B, I]) =>
              h.createElement(
                nu,
                { key: B, label: B, level: "subsection", colSpan: b },
                I.map((M) => h.createElement(ma, { key: M.key, row: M, arg: p && p[M.key], expandable: x, ...F })),
              ),
            ),
            Object.entries(E.sections).map(([B, I]) =>
              h.createElement(
                ...
                I.ungrouped.map((M) => h.createElement(ma, { key: M.key, row: M, arg: p && p[M.key], ...F })),
                Object.entries(I.subsections).map(([M, w]) =>
                  h.createElement(
                    nu,
                    { key: M, label: M, level: "subsection", colSpan: b },
                    w.map((N) => h.createElement(ma, { key: N.key, row: N, arg: p && p[N.key], expandable: x, ...F })),
                  ),
                ),
              ),
            ),
  ...
  var Bne = q.div(({ theme: e }) => ({ fontWeight: e.typography.weight.bold, color: e.color.defaultText })),
    Tne = q.div(({ theme: e }) => ({
    ...
    kne = q.div({ display: "flex", flexDirection: "column", flex: 1, position: "relative", marginBottom: 30 }),
  ...
  var aI = (e) => `anchor--${e}`,
    oI = ({ storyId: e, children: t }) => h.createElement("div", { id: aI(e), className: "sb-anchor" }, t);
  ue &&
  ...
  var uI = (e, t) => {
    ...
    lu = (e, t, r, n, a, o) => ({ ...e, ...(0, Iy.default)(t, (i) => ({ rows: e2(i, r, n, a), sort: o })) }),
    cI = (e) => {
      let t = je(Qe),
      ...
      try {
        ...
        if (
          (B || ((m = null), (g = null), (F = {})), n && (!B || o) && (F = lu(F, { [x]: n }, y.parameters, i, u)), a)
        ) {
          if (Array.isArray(a))
            throw new Error(
...
`));
  ...
  var cu = Ha.a,
    ...
    _I = (e) => {
      ...
      return h.createElement(Xo, {
        ...e,
        options: { forceBlock: !0, overrides: { code: CI, a: SI, ...TI, ...e?.options?.overrides }, ...e?.options },
      });
    },
    OI = ((e) => ((e.INFO = "info"), (e.NOTES = "notes"), (e.DOCGEN = "docgen"), (e.AUTO = "auto"), e))(OI || {}),
    ya =
    ...
    NI = ({ type: e, markdown: t, children: r }, { storyById: n }) => {
      ...
      (i || u) &&
        ye(`Using 'parameters.notes' or 'parameters.info' properties to describe stories is deprecated. See ${ya}`);
    ...
    Wne = q.div(({ theme: e }) => ({ width: "10rem", "@media (max-width: 768px)": { display: "none" } })),
    Vne = q.div(({ theme: e }) => ({
      position: "fixed",
      bottom: 0,
      top: 0,
  ...
  var MI = ({ children: e, disableAnchor: t }) => {
    ...
    qI = ({ of: e, expanded: t = !0, withToolbar: r = !1, __forceInitialArgs: n = !1, __primary: a = !1 }) => {
      let { story: o } = gu(e || "story", ["story"]),
        i = o.parameters.docs?.canvas?.withToolbar ?? r;
      return h.createElement(
        oI,
        { storyId: o.id },
        t && h.createElement(h.Fragment, null, h.createElement(MI, null, o.name), h.createElement(LI, { of: e })),
        h.createElement(DI, {
          of: e,
          withToolbar: i,
      ...
      return (
        ...
        !n || n.length === 0
          ...
          : h.createElement(
              ...
              n.map(
                (a) =>
                  a && h.createElement(qI, { key: a.id, of: a.moduleExport, expanded: !0, __forceInitialArgs: !0 }),
              ),
            )
      );
    };
  ...
  xa.register(va, (e) => {
    xa.add(va, {
      ...
      paramKey: Da,
      render: ({ active: t }) =>
        !t || !e.getCurrentStoryData() ? null : h.createElement(wa, { active: t }, h.createElement(UI, null)),
    });
  });
} catch (e) {
