try {
  ...
  var ue = (e, t, s, o) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of ie(t))
        !se.call(e, i) && i !== s && F(e, i, { get: () => t[i], enumerable: !(o = oe(t, i)) || o.enumerable });
    return e;
  };
  var de = (e, t, s) => (
    (s = e != null ? ne(ae(e)) : {}),
              ...
              i.exports = function (a) {
                ...
                return function (b) {
                  var p = function () {
                    ...
                    for (k = 0; k < O; k++) {
                      if (((B[k] = { cacheItem: y, arg: arguments[k] }), y.has(arguments[k]))) {
                        y = y.get(arguments[k]);
                        continue;
                      }
                      (C = !1), (S = new l(!1)), y.set(arguments[k], S), (y = S);
                    }
                    return (
                      C && (y.has(arguments[O]) ? (A = y.get(arguments[O])) : (C = !1)),
                      C || ((A = b.apply(null, arguments)), y.set(arguments[O], A)),
                      a > 0 &&
    ...
    var i = o.reduce(function (n, r) {
      ...
      return u
        ? n.concat(
            u.map(function (a) {
              var h, d;
              return (d = (h = a.match(/[\t ]/g)) === null || h === void 0 ? void 0 : h.length) !== null && d !== void 0
                ? d
                : 0;
            }),
          )
      ...
      return e.disable
        ...
        : T.createElement(
            ...
            T.createElement(
              ...
              T.createElement(
                z,
                { key: "background", title: "Change the background of the preview", active: l !== "transparent" || t },
