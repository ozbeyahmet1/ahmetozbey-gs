...
var createModuleInfo = (m) => ({ type: "esm", varName: Keys[m], namedExports: exports_default[m], defaultExport: !0 }),
  definitions = Object.keys(Keys).reduce((acc, key) => ((acc[key] = createModuleInfo(key)), acc), {});
