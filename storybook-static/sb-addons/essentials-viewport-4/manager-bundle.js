try {
  ...
  var me = (e, t, o, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let p of pe(t))
        !ue.call(e, p) && p !== o && H(e, p, { get: () => t[p], enumerable: !(n = le(t, p)) || n.enumerable });
    return e;
  };
  var ce = (e, t, o) => (
    (o = e != null ? ae(he(e)) : {}),
                  ...
                  return this.lastItem && this.isEqual(this.lastItem.key, r)
                    ...
                    : ((x = this.indexOf(r)),
                      x >= 0
                        ...
                        : ((this.lastItem = { key: r, val: i }), this.list.push(this.lastItem), this.size++, this));
                }),
                (h.prototype.delete = function (r) {
                  var i;
                  if (
                    (this.lastItem && this.isEqual(this.lastItem.key, r) && (this.lastItem = void 0),
                    (i = this.indexOf(r)),
                    i >= 0)
                  )
              ...
              p.exports = function (s) {
                ...
                return function (b) {
                  var l = function () {
                    ...
                    return (
                      E && (a.has(arguments[I]) ? (A = a.get(arguments[I])) : (E = !1)),
                      E || ((A = b.apply(null, arguments)), a.set(arguments[I], A)),
                      s > 0 &&
  ...
  var ye = (0, D.default)(50)((e) => [
    ...
    Ee = $(
      re(({ theme: e }) => {
        let { viewports: t = G, defaultOrientation: o = "portrait", defaultViewport: n = P.id, disable: p } = J(q, {}),
        ...
        r.find((d) => d.id === n) ||
          ...
          L(() => {
            h({ selected: n || (m.selected && t[m.selected] ? m.selected : P.id), isRotated: o === "landscape" });
          }, [o, n]);
          ...
          p || Object.entries(t).length === 0
            ...
            : S.createElement(
                ...
                S.createElement(
                  ...
                  {
                    placement: "top",
                    tooltip: ({ onHide: d }) => S.createElement(oe, { links: we(r, b, h, m, d) }),
                  ...
                  S.createElement(
                    ...
                    a ? S.createElement(ve, null, u ? `${b.title} (L)` : `${b.title} (P)`) : null,
                  ),
                ),
                a
                  ? S.createElement(
