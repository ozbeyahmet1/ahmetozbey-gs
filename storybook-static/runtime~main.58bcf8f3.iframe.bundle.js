(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        99: "component-example-example-stories",
        130: "component-checkbox-checkbox-stories",
        397: "component-tooltip-tooltip-stories",
        578: "component-colorBadge-colorBadge-stories",
        642: "component-toggle-toggle-stories",
        875: "component-card-card-stories",
      })[chunkId] || chunkId) +
      "." +
      {
        99: "c7c57611",
      ...
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (var scripts = document.getElementsByTagName("script"), i = 0; i < scripts.length; i++) {
            var s = scripts[i];
            if (s.getAttribute("src") == url || s.getAttribute("data-webpack") == "greenspark:" + key) {
              script = s;
              break;
            }
          }
        script ||
          ...
          script.setAttribute("data-webpack", "greenspark:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkgreenspark = self.webpackChunkgreenspark || []);
