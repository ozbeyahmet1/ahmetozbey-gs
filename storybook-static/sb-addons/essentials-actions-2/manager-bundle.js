try {
  ...
  function D(e, t) {
    ...
    if (e && t && (r = e.constructor) === t.constructor) {
      ...
      if (r === Set) {
        ...
        for (n of e) if (((o = n), (o && typeof o == "object" && ((o = Ue(t, o)), !o)) || !t.has(o))) return !1;
        return !0;
      }
      if (r === Map) {
        if (e.size !== t.size) return !1;
        for (n of e)
          if (((o = n[0]), (o && typeof o == "object" && ((o = Ue(t, o)), !o)) || !D(n[1], t.get(o)))) return !1;
        return !0;
      }
      ...
      if (!r || typeof e == "object") {
        n = 0;
        for (r in e) if ((je.call(e, r) && ++n && !je.call(t, r)) || !(r in t) || !D(e[r], t[r])) return !1;
  ...
  var ct = Object.create,
    ...
    bt = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let o of Ye(t))
          !dt.call(e, o) && o !== r && se(e, o, { get: () => t[o], enumerable: !(n = pt(t, o)) || n.enumerable });
      return e;
    },
    gt = (e, t, r) => (
      (r = e != null ? ct(ft(e)) : {}),
  ...
  var Ot = {
    ...
    Tt = ({ expanded: e, styles: t }) =>
      a.createElement("span", { style: { ...t.base, ...(e ? t.expanded : t.collapsed) } }, "\u25B6"),
    _t = H((e) => {
      e = {
        expanded: !0,
      ...
      return a.createElement(
        ...
        a.createElement("ol", { role: "group", style: l.treeNodeChildNodesContainer }, t ? n : void 0),
      );
    }),
    K = "$",
    Ge = "*";
  ...
  var Rt = (e) => Array.from({ length: e }, (t, r) => [K].concat(Array.from({ length: r }, () => "*")).join(".")),
    At = (e, t, r, n, o) => {
      let i = []
          .concat(Rt(n))
          .concat(r)
        ...
        i.forEach((s) => {
          let l = s.split("."),
            c = (p, d, f) => {
              ...
              else if (E === Ge) for (let { name: h, data: y } of t(p)) X(y, t) && c(y, `${d}.${h}`, f + 1);
              else {
                let h = p[E];
                X(h, t) && c(h, `${d}.${E}`, f + 1);
              }
    ...
    Xe = H((e) => {
      ...
      return a.createElement(
        _t,
        { expanded: c, onClick: p, shouldShowArrow: l, shouldShowPlaceholder: o > 0, nodeRenderer: i, ...e },
        c
    ...
    Ze = H(({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: o, expandLevel: i }) => {
      let u = _("TreeView"),
        s = I({}),
        [, l] = s;
      return (
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(Xe, { name: e, data: t, dataIterator: r, depth: 0, path: K, nodeRenderer: n }),
          ),
        )
      );
    }),
  ...
  var ie = ({ data: e }) => {
    ...
    wt = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
      ...
      return a.createElement(
        "span",
        null,
        typeof e == "string" ? a.createElement(ce, { name: e, dimmed: r }) : a.createElement(ie, { data: e }),
        a.createElement("span", null, ": "),
  ...
  var Mt = ({ rows: e, columns: t, rowsData: r }) => {
    ...
    Ve = ({ sortAscending: e = !1, sorted: t = !1, onClick: r = void 0, borderStyle: n = {}, children: o, ...i }) => {
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              "tr",
              null,
              a.createElement(Ve, { borderStyle: c.none, sorted: r && n, sortAscending: i, onClick: s }, e),
              t.map((p) =>
                a.createElement(
                  Ve,
                  { borderStyle: c.solid, key: p, sorted: r && o === p, sortAscending: i, onClick: u.bind(null, p) },
                  p,
                ),
              ),
            ),
    ...
    zt = ({ data: e, columns: t }) => {
      ...
      if (
        (i !== void 0
          ? (E = f.map((h, y) => (typeof h == "object" && h !== null ? [h[i], y] : [void 0, y])))
          : o && (E = p.map((h, y) => [p[y], y])),
        E !== void 0)
      ) {
        let h = (O, N) => (lt, ut) => {
            ...
            if (Te === _e) F = Re(Oe, ve);
              ...
              let z = { string: 0, number: 1, object: 2, symbol: 3, boolean: 4, undefined: 5, function: 6 };
              F = Re(z[Te], z[_e]);
            }
            return N || (F = -F), F;
          },
    ...
    Qe = (e) =>
      ...
      (e.childNodes.length === 1 && e.childNodes[0].nodeType === Node.TEXT_NODE && e.textContent.length < jt),
    ...
    Gt = ({ isCloseTag: e, data: t, expanded: r }) => {
      ...
      if (e) return a.createElement($e, { styles: n.htmlCloseTag, isChildNode: !0, tagName: t.tagName });
      switch (t.nodeType) {
        case Node.ELEMENT_NODE:
          return a.createElement(
            "span",
            null,
            a.createElement(Ut, { tagName: t.tagName, attributes: t.attributes, styles: n.htmlOpenTag }),
  ...
  function lr(e, t, r) {
    ...
    if (typeof e == "object" && t === void 0 && r === void 0) return Q(e.hue, e.saturation, e.lightness);
    throw new T(1);
  }
  function ur(e, t, r, n) {
  ...
  function ye(e, t, r) {
    if (typeof e == "number" && typeof t == "number" && typeof r == "number") return Ee("#" + x(e) + x(t) + x(r));
    if (typeof e == "object" && t === void 0 && r === void 0) return Ee("#" + x(e.red) + x(e.green) + x(e.blue));
    throw new T(6);
  }
  function ee(e, t, r, n) {
  ...
  var xr = j.div({
    ...
    Ir = ({ children: e, className: t }) => a.createElement(ze, { horizontal: !0, vertical: !0, className: t }, e),
    ...
    return (
      ...
      a.createElement(
        ...
        a.createElement(
          He,
          { col: 1 },
          a.createElement("span", { style: { display: "inline-block", verticalAlign: "middle" } }, "Actions"),
